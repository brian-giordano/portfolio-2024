...
export default function MonthlyCarePage() {
  return (
    <div className="bg-darkSlate min-h-screen flex flex-col pt-8">
      ...
      <main className="flex-grow max-w-5xl mx-auto px-6 pt-10 pb-16 w-full">
        ...
        <p className="text-xl text-ivoryWhite font-subheader mb-16 max-w-3xl">
          Optional retainer plans to ensure your website remains secure,
          updated, and effective, allowing you to dedicate your time to running
          your business rather than managing your site.
        </p>

        {/* Side-by-Side Comparison Grid */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-ivoryWhite mb-8 text-center md:text-left">
            Compare Care Plans
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-charcoal border border-white/5 rounded-2xl flex flex-col overflow-hidden hover:border-white/10 transition-colors shadow-xl">
              <div className="p-8 border-b border-white/5 flex-grow">
                <h3 className="text-2xl font-bold text-ivoryWhite mb-2">
                  Monthly Care Lite
                </h3>
                <div className="flex items-baseline gap-2 mt-4 mb-6">
                  <span className="text-4xl font-bold text-ivoryWhite">
                    $250
                  </span>
                  <span className="text-silverMist">/month</span>
                </div>
                <p className="text-silverMist text-sm mb-8 leading-relaxed h-auto md:h-16">
                  Ideal for stable businesses that require occasional content
                  updates and baseline technical peace of mind.
                </p>

                <h4 className="text-xs uppercase tracking-widest font-bold text-gold mb-4">
                  Included Features
                </h4>
              ...
              <div className="p-8 bg-black/20">
                <a
                  ...
                  className="block w-full text-center border-2 border-gold text-gold font-bold py-4 rounded-xl hover:bg-gold/10 hover:-translate-y-1 transition-all duration-300"
                >
                  Select Lite
                </a>
              </div>
            ...
            <div className="bg-charcoal border border-gold/30 rounded-2xl flex flex-col relative overflow-hidden shadow-[0_0_30px_rgba(255,215,0,0.05)]">
              ...
              <div className="p-8 border-b border-white/5 flex-grow">
                ...
                <p className="text-silverMist text-sm mb-8 leading-relaxed h-auto md:h-16">
                  Designed for active, growing businesses that require
                  consistent updates, priority service, and proactive
                  optimization.
                </p>
        ...
        <div className="bg-black/30 border border-white/5 rounded-2xl p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-sm">
            <div>
              ...
              <p className="text-silverMist leading-relaxed">
                General hosting, active security monitoring, ongoing content
                updates, routine broken link checks, and priority technical
                edits.
              </p>
            </div>
            <div>
              ...
              <p className="text-silverMist leading-relaxed">
                Outages caused by third-party services, comprehensive full-site
                redesigns, entirely new page builds, or custom development
                exceeding Webflow&apos;s native capabilities.
              </p>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t border-white/5">
            ...
            <p className="text-silverMist text-xs leading-relaxed">
              Plans are billed monthly via Stripe. A standard 30-day
              cancellation notice applies. We will sign a clear service
        ...
        <div className="text-center py-16 mt-16 border-t border-white/5">
          ...
          <p className="text-silverMist mb-8 text-lg">
            Send me a quick message and we can figure out which care plan is
